...
public class PhotoGalleryFragment extends Fragment {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mThumbnailDownloader.setThumbnailDownloaderListener((PhotoHolder holder, Bitmap bitmap) -> {
...
//        getActivity().startService(intent);
    ...
    private static class FetchItemsTask extends AsyncTask<Void, Void, List<GalleryItem>> {
        ...
        private FetchItemsTask(PhotoGalleryFragment photoGalleryFragment, String query) {
